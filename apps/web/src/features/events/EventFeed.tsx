              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 mb-1.5">
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-xs text-slate-900 bg-slate-100 px-1.5 py-0.5 rounded border border-slate-200">
                      {symbol}
                    </span>
                ...
                <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-100/80 text-xs text-slate-500">
