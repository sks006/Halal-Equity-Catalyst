...
pub fn create_router(state: Arc<AppState>) -> Router {
    ...
    Router::new()
        ...
        .route(
            "/dbc/pools",
            get(list_dbc_pools_handler).post(record_dbc_pool_handler),
        )
        ...
        .route(
            ...
            get(get_policy_handler).put(create_or_update_policy_handler),
        )
        .route(
            "/policies",
            get(list_policies_handler).post(create_or_update_policy_handler),
        )
